...
for i in range(10000):
    real_train.append(loaded[0])

train_images = np.array(real_train)

plt.imshow(train_images[0], cmap='gray')
plt.axis('off')
plt.savefig('/content/drive/MyDrive/orginal.png')
plt.close()
...
plt.axis('off')
plt.savefig('/content/drive/MyDrive/BEFOREEVERYTHING.png')
plt.close()
...
def generate_and_save_images(model, epoch, test_input):
    ...
    plt.savefig('/content/drive/MyDrive/image_at_epoch_{:04d}.png'.format(epoch))
    plt.close()
